    ...
    <View style={ styles.page_container }>
      <ScrollView>
        ...
        <View style={{ alignItems: 'center' }}>
          <Text style={{ color: 'black', fontSize: 30, fontWeight: '700', paddingTop: 120, opacity: 0.7 }}>Welcome</Text>
          <Text style={{ fontSize: 13, fontWeight: '500', color: 'grey', paddingTop: 15 }}>Discover Your Path</Text>
        </View>
        ...
        <Text style={{  fontSize: 11, marginHorizontal: 42, marginTop: 20, color: 'grey', textAlign: 'center' }}>By Clicking On Sign Up You Accept Our <Text style={{ fontWeight: '500' }}>Terms Of Service</Text> And <Text style={{ fontWeight: '500' }}>Privacy Policy</Text></Text>
