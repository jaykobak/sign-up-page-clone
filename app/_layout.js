  ...
  return (
    <View style={ styles.page_container }>
      ...
      <View style={{ alignItems: 'center' }}>
        <Text style={{ color: '#756eae', fontSize: 30, fontWeight: '700', paddingTop: 100 }}>Welcome back</Text>
        <Text style={{ fontSize: 13, fontWeight: '500', color: '#756eae', paddingTop: 10 }}>Continue Your Path</Text>
      </View>
      ...
      <TouchableOpacity activeOpacity={0.7} style={ styles.other_login_opt }>
        ...
        <Text style={{ color: 'white', fontWeight: '500' }}>Login With Facebook</Text>
      </TouchableOpacity>
      {/* Google */}
      <TouchableOpacity activeOpacity={0.7} style={ styles.other_login_opt }>
        <Image source={require('../assets/icons/google-icon.png')} style={{ width: 30, height: 30 }}/>
        <Text style={{ color: 'white', fontWeight: '500' }}>Login With Google</Text>
      </TouchableOpacity>
      {/* Apple */}
      <TouchableOpacity activeOpacity={0.7} style={ styles.other_login_opt }>
        <Image source={require('../assets/icons/apple-icon.png')} style={{ width: 30, height: 30 }}/>
        <Text style={{ color: 'white', fontWeight: '500' }}>Login With Apple</Text>
      </TouchableOpacity>
